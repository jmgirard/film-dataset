...
> All information in this section came directly from [Wikipedia](https://en.wikipedia.org/wiki/Zodiac_(film)).

:::
::: {.column width="10%"}
:::
::: {.column width="20%" .poster}
![](./img/Zodiac_poster.jpg)
:::
:::
...
*Note that the time stamps listed on this page correspond to the Director's Cut edition.*
